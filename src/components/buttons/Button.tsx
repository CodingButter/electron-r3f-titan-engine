...
const Button = ({ children, neutral, primary, success, info, danger, warn, size = "md", dark, light, className, active, disabled, ...rest }:ButtonProps) => {
    return (
        <button
            className={classNames(
                ...
                "focus:outline-none",
                active && "bg-neutral-750 active:text-neutral-50",
                "disabled:bg-neutral-550 disabled:text-neutral-400",
                className
            )}
            disabled={disabled}
            {...rest}
