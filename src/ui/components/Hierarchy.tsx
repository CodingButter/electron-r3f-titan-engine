...
const Hierarchy = ({expanded,setExpanded}:HierarchyProps) => {
    const { scene, selectedObjects, selectObjects, gameLoaded, addBlockToScene } = useTitan();
    ...
    const addGameObject = () => {
        const gameObject = addBlockToScene();
        selectObjects([gameObject.id]);
    }
                            ...
                            <GameObjectItem
                                ...
                                onClick={() => {
                                    if (selectedObjects.includes(gameObject.id))
                                        ...
                                        selectedObjects.push(gameObject.id);
